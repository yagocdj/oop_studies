...
public class Repositorio {
	...
	public void	salvarObjetos()  {
		...
		try	{
			...
			throw new RuntimeException("problema na criação do arquivo  prateleiras "+e.getMessage());
		}
		...
		try	{
			...
			throw new RuntimeException("problema na criação do arquivo  produtos "+e.getMessage());
		}
