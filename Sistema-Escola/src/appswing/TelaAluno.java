...
public class TelaAluno {
	...
	private void initialize() {
		...
		button_2 = new JButton("Cancelar Matricula");
		...
		button_3 = new JButton("Matricular na turma");
	...
	public void listagem () {
		try{
			...
			for(Aluno p : lista)
				if(p.getTurma()==null)
					model.addRow(new Object[]{  p.getNome(), p.getMedia(), "sem turma" });
				else
					model.addRow(new Object[]{  p.getNome(), p.getMedia(), p.getTurma().getId() });
